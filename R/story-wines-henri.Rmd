...
`r colorize("hint", "blue")`: you need to inspect the created R-object which contains the importance scores in a data.frame (see `?FeatureImp`)
...
Plot the PDP and add ICE curves.
